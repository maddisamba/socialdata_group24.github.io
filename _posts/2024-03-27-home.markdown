...
<div id="map-visualization" class="border"><!-- Map visualization here -->
                    <!--<img src="time_series_chart.png" class="img-fluid" alt="Time Series Chart of SF Crime">-->
                    <iframe src="F:/Masters/Social Data Visualizations/socialdata_group24.github.io/DistrictWiseTrends.html" frameborder="0" width="500px" height="500px">                     </iframe></div>
                </section>
