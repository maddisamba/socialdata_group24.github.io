...
<head>
    ...
    <style>
        .header { background: #007bff; color: white; padding: 10px; font-size: 1.5rem; text-align: center; }
    </style>
</head>
<body>
    <div class="header">
