...
This site will focus on crime data from 2003 to 2017 for San Francisco. We'll narrow our analysis to prostitution crime in the city to gain a clearer view of crime in San Francisco and uncover some insights in patterns or ability to make observations that could be relevant or interesting. For our analysis we will provide three different types of visualizations. The first one is a time series of prostituion crimes along the years by district, the second is a map displaying the occurences of prostituion and other focus crimes by district for comparinson and the third is a interactive analysis of the crime data per hour per district.
                ...
                <section id="visualization-2" class="visualization">
                    ...
                    <p style="text-align:justify;width:100%">Our second visualization delves into the geographical distribution of crime in San Francisco, focusing on identifying hotspots across the city's neighborhoods over time. While our primary focus was on understanding the prevalence of prostitution, we also examined other crime types to uncover potential correlations with prostitution occurrences in high-crime areas. As depicted in the first plot, the map highlights that the Mission district hosts the majority of prostitution-related crimes, with a significant presence in the Northern district as well. Notably, our analysis revealed that the crime of Disorderly Conduct also exhibited a disproportionately high occurrence in the Mission district, hinting at potential interrelations between these offenses. After investigating, we discovered that <a href="https://johndrogerslaw.com/practice-areas/sex-crimes/california-penal-code-647b-prostitution/">prostitution is considered a form of disorderly conduct codified under California Penal Code 647(b)</a>. However, it remained unclear why there were more cases of prostitution than disorderly conduct by this criteria.</p>
                    ...
                    <select id="map-selection">
                        ...
                        <option value="sex_offenses_map">Sex Offenses Map</option>
                    ...
                    <br><p style="text-align:justify;width:100%"><a href="https://www.tandfonline.com/doi/abs/10.1300/J013v27n03_03">A study from 2008</a> also explored the relationship between prostitution, violence, and post-traumatic stress disorder in San Francisco. According to the study, from the one hundred and thirty people working as prostitutes interviewed, fifty-seven percent reported that they had been sexually assaulted as children and 49% reported that they had been physically assaulted as children. As adults in prostitution, 82% had been physically assaulted; 83% had been threatened with a weapon; 68% had been raped while working as prostitutes; and 84% reported current or past homelessness. The relation aligns with the map, which also displays high numbers of assaults and sex offenses in the Mission district.</p>
                </section>
