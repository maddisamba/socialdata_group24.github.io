...
<body>
    <div class="header">
        <div class="container">
            <h1>Prostitution crime Trends in San Francisco (2003-2017)</h1>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <section id="introduction">
                    <p style="text-align:justify;width:635px">
