...
This site will focus on crime data from 2003 to 2017 for San Francisco. We'll narrow our analysis to prostitution crime in the city to gain a clearer view of crime in San Francisco and uncover some insights in patterns or ability to make observations that could be relevant or interesting. For our analysis we will provide three different types of visualizations. The first one is a time series of prostituion crimes along the years by district, the second is a map displaying the occurences of prostituion and other focus crimes by district for comparinson and the third is a interactive analysis of the crime data per hour per district.
                ...
                <section id="visualization-2" class="visualization">
                    ...
                    <p style="text-align:justify;width:100%">Our second visualization explores the geographical aspect of crime in San Francisco, with a focus on identifying hotspots across the city's neighborhoods over time. While our primary emphasis was on understanding the prevalence of prostitution, we also examined other crime types to unveil potential correlations with prostitution occurrences in high-crime areas. As seen in the first plot, the map highlights that the Mission district hosts the majority of prostitution-related crimes, with a significant presence in the Northern district as well. Interestingly, the crime of Disorderly Conduct also exhibits a disproportionately high occurrence in the Mission district, hinting at potential interrelations between these offenses. <a href="https://www.tandfonline.com/doi/abs/10.1300/J013v27n03_03">An article from 2008</a> that studied the exact case managed to investigate more the problem. From the 130 people working as prostitutes interviewed, it stated that fifty-seven percent reported that they had been sexually assaulted as children and 49% reported that they had been physically assaulted as children. As adults in prostitution, 82% had been physically assaulted; 83% had been threatened with a weapon; 68% had been raped while working as prostitutes; and 84% reported current or past homelessness.</p>
